...
let tempObject = {};
let listOfUrls = [];
let techNamesArray = ["angular","react","android","ios","nodejs","ruby-on-rails","java","python","react-native"];

 function getProfileLinks(){

return new Promise((resolve,reject) => {

    for(let j =0;j<techNamesArray.length;j++) {

        let URL = `https://www.toptal.com/${techNamesArray[j]}`;
...
function writeDataToJson() {
    ...
    //     users:dbObject
    // };
    const jsonContent = JSON.stringify(dbObject);
